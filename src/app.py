...
if topic:
    ...
    st.caption("⚠️ These figures aggregate all recorded votes linked to this topic (multiple readings, amendments). Individual vote breakdowns may differ from other sources.")

    st.divider()
    st.subheader(t("ai_section"))
    st.caption("Get a plain-language explanation of what this vote was about, who supported it and why — generated by AI in seconds.")
